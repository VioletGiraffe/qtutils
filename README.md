...
| `widgets/cfindbar.h` | Find bar searching through host-supplied functions: pattern history, previous and next, case, whole-word and regex toggles, optional `QSettings` persistence; its find actions carry host-chosen keys. |
